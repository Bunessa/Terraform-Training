...
resource "aws_subnet" "az1" {
  vpc_id                  = var.vpc_id
  cidr_block              = local.subnet_allocation.busisiwe_sithole.subnets[0]
...
resource "aws_subnet" "az2" {
  vpc_id                  = var.vpc_id
  cidr_block              = local.subnet_allocation.busisiwe_sithole.subnets[1]
...
resource "aws_subnet" "az3" {
  vpc_id                  = var.vpc_id
  cidr_block              = local.subnet_allocation.busisiwe_sithole.subnets[2]
...
resource "aws_eks_node_group" "eks-ng" {
  cluster_name    = aws_eks_cluster.eks-cluster.name
  node_group_name = "sitholebs-eks-ng-dev"
